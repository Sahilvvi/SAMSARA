...
const Services = () => {
  return (
    <>
      <div className="relative h-full w-full overflow-hidden bg-[#003249] pb-10">
        <div className="services__wrapper mx-auto flex h-full max-w-7xl flex-col items-center justify-start">
          ...
          <p className="mt-2 text-left font-[Satoshi] text-lg font-medium capitalize text-[#c5a67f]">
