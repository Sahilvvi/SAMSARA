...
const Footer = () => {
  return (
    <div className="footer h-full w-full bg-[#003249] pt-16">
      <div className="mx-auto flex w-full items-start justify-between py-10 sm:flex-col sm:px-4 md:px-10 xl:max-w-7xl">
        <div className="flex flex-col items-start justify-start gap-7 md:w-1/2 xl:w-[40%]">
          <div className="footer_img flex items-center justify-center gap-3">
            <div className="logo h-20 w-20 xxl:h-24 xxl:w-36">
              <img
                src="/images/logo.png"
                alt="SamSara Logo"
            ...
            <p className="text-left font-[Satoshi] font-semibold capitalize text-[#c5a67f] md:text-xl lg:text-2xl">
              SamSara Consultancy
            </p>
          </div>
